...
|--------|--------------|-------------|----------|
| **KVM** | `/dev/kvm` access (bare metal or nested virt) | ⚡ Fastest (85ms cold start) | Production bare-metal servers |
| **PVM** | Any Linux VPS | 🚀 Fast (150ms cold start) | Any cloud VPS (Hetzner Cloud, DigitalOcean, AWS EC2, etc.) |
| **WASM** | Any Linux system | 🏃 Lightest (<10ms cold start) | Function workloads, edge compute |

> **Automatic Selection**: ShellWeGo automatically detects and uses the best available backend.
...
| Provider | KVM Mode | PVM Mode | WASM Mode |
|----------|----------|----------|----------|
| Hetzner Cloud | ❌ Not supported | ✅ Supported | ✅ Supported |
| Hetzner Dedicated | ✅ Supported | ✅ Supported | ✅ Supported |
| AWS EC2 (regular) | ❌ Not supported | ✅ Supported | ✅ Supported |
| AWS EC2 (.metal) | ✅ Supported | ✅ Supported | ✅ Supported |
| DigitalOcean | ❌ Not supported | ✅ Supported | ✅ Supported |
| DigitalOcean Metal | ✅ Supported | ✅ Supported | ✅ Supported |
| Linode/Akamai | ⚠️ Limited | ✅ Supported | ✅ Supported |
| Vultr | ❌ Not supported | ✅ Supported | ✅ Supported |
| OVH VPS | ❌ Not supported | ✅ Supported | ✅ Supported |
| Bare Metal | ✅ Best Performance | ✅ Supported | ✅ Supported |

> ⚠️ **WARNING**: Attempting to use KVM mode on VPS providers that don't support nested virtualization may result in account suspension. ShellWeGo will automatically detect and fall back to PVM mode.
...
- Firecracker microVM runtime (KVM: 85ms, PVM: 150ms cold start)
...
See **Prerequisites** section above for detailed requirements.

#### Quick Reference

| Mode | Min RAM | Recommended RAM | Cold Start |
|------|---------|-----------------|------------|
| KVM | 4GB | 64GB+ | 85ms |
| PVM | 2GB | 16GB+ | 150ms |
| WASM | 1GB | 4GB+ | <10ms |

**Critical for all modes:** Disable swap for optimal performance.
