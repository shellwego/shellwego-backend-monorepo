...
impl FirecrackerDriver {
    ...
    fn to_boot_source(_config: &super::MicrovmConfig) {
    }

    /// Convert MicrovmConfig to firecracker-rs MachineConfig
    fn to_machine_config(_config: &super::MicrovmConfig) {
    }

    /// Convert DriveConfig to firecracker-rs Drive
    fn to_drive(_drive: &super::DriveConfig) {
    }

    /// Convert NetworkInterface to firecracker-rs NetworkInterface
    fn to_network_interface(_net: &super::NetworkInterface) {
    }
...
firecracker = { path = "../shellwego-firecracker" }
